...
description: "**Русская версия Consulting Problem Solving Framework** — интерактивное решение сложных бизнес- и организационных задач: ты ассоциат, пользователь — партнёр, принимающий решения. 8 шагов с артефактами и явным утверждением на каждом: определение проблемы, MECE-дерево, приоритизация, план работ, анализ, синтез, рекомендации, коммуникация. Финальная проза по Strunk & White. Активируй на: стратегический консалтинг, фреймворк решения проблем, дерево проблемы, issue tree, MECE, гипотезо-ориентированный подход, пирамида Минто, анализ 80/20, поиск первопричин, бизнес-кейс, стратегическая рекомендация, case interview, структурное мышление, структурный подход. Также на формулировки: «помоги структурно подумать», «помоги мне продумать эту проблему», «как бы консультант подошёл», «разложи задачу», «проанализируй бизнес-ситуацию», «нужен структурный подход к X». Используй, когда запрос требует структурного аналитического решения с артефактами."
---
