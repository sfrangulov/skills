...
description: "**Consulting Problem Solving Framework (русская версия)**: интерактивный, ведомый пользователем подход к решению сложных бизнес- и организационных задач по структурной консалтинговой методике. Ты выступаешь в роли консалтингового ассоциата (consulting associate); пользователь — консалтинговый партнёр (consulting partner), который принимает решения. Скил проводит через определение проблемы, MECE-структурирование, приоритизацию, планирование работ, анализ, синтез, рекомендации и коммуникацию — пользователь даёт вводные, делает выбор и проверяет артефакты на каждом шаге, прежде чем двигаться дальше. На каждом этапе создаются артефакты: рабочие markdown-документы, таблицы для анализа данных, и финальный контент слайдов (.md) или утверждённый контент вертикального документа. Этот скил отвечает только за контент и структуру — визуальный рендеринг, стилизация и сборка дека/документа выполняются скилами-сборщиками вниз по конвейеру. Финальная проза отшлифована по интегрированному руководству Strunk & White. Используй этот скил, когда пользователь упоминает: strategy consulting, problem solving framework, issue tree, MECE, hypothesis-driven, pyramid principle, 80/20 analysis, root cause analysis, business case analysis, strategic recommendation, case interview prep, structured thinking, или просит системно разобрать и решить сложную задачу. По-русски активируй на: стратегический консалтинг, фреймворк решения проблем, дерево проблемы, дерево вопросов, MECE, гипотезо-ориентированный, принцип пирамиды, пирамида Минто, анализ 80/20, поиск первопричин, бизнес-кейс, стратегическая рекомендация, структурное мышление, структурный подход, помоги структурно подумать, как бы это решил консультант, проанализируй бизнес-ситуацию, разложи задачу. Также активируй на формулировки вроде «помоги мне продумать эту проблему», «мне нужен структурный подход к X», «как бы консультант подошёл к этому», «структурный подход к», «issue tree», «дерево проблемы». Активируй, когда запрос явно требует структурного аналитического решения задачи с артефактами."
---
...
Перед тем как собирать любой финальный артефакт (шаг 8 — дек или документ), **запусти скептический ревью-сабагент** через инструмент Task (`subagent_type: "general-purpose"`). Этот агент работает как нейтральный безкомпромиссный ревьюер, чья единственная задача — искать дыры.
